 ...
 * ADD_BOOK - аналогично. только надо еще перед книгой id ее автора кинуть. 
 ...
 * SET_AUTHOR - аналогично. пока лучше не придумал. 
 * REMOVE_BOOK - Аналогично SET, разумеется без передачи новой книги в конце
 * REMOVE_AUTHOR - Аналогично 
 * VIEW_BOOKS - после OK последует сериализованный AuthorContainer. пока так.
 * VIEW_AUTHORS - аналогично.
 * BYE - посылайте как сигнал окончания сессии
 */
